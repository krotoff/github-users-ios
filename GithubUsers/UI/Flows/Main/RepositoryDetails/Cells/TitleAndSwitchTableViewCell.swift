...
final class TitleAndSwitchTableViewCell: UITableViewCell {
    
    // MARK: - Internal properties
    
    static let identifier = String(describing: TitleAndSwitchTableViewCell.self)
    ...
    func configure(title: String, isLiked: Bool, changedLikeState: @escaping ((Bool) -> Void)) {
        titleLabel.text = title
        likeSwitch.isOn = isLiked
